...
const Reviews = () => {
    ...
    return (
        <section className="py-14 bg-gradient-to-b from-white via-green-50/40 to-white">
            <div className="w-11/12  mx-auto">
                ...
                <Marquee speed={50} pauseOnHover gradient gradientColor="#ffffff">
                    {reviews.map((review, index) => (
                        <div key={index} className="mx-4">

                            <div className="w-80 bg-white border border-green-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition">
